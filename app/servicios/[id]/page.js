...
export default async function Page({ params }) {
    ...
    return <>
        <main className="h-[800px] w-full relative">
            <Image src={servicio?.gallery[0].img} alt={servicio?.gallery[0].alt} className="w-full h-full object-cover" width={0} height={0} />
                    ...
                    <div className=" mt-10 lg:-mx-4 relative-20 lg:mt-0 lg:col-start-1">
                        <div className=" space-y-4">
                            <div className="flex items-end justify-center space-x-4 lg:justify-start">
                                <Image className="w-32 rounded-lg shadow-lg md:w-56 object-cover h-80" width="200" height={200} src={servicio?.gallery[0].img} alt={servicio?.gallery[0].alt} />
                                <Image className="w-36 rounded-lg shadow-lg md:w-64 object-cover h-72" width="260" height={200} src={servicio?.gallery[1].img} alt={servicio?.gallery[1].alt} />
                            </div>
                            <div className="flex items-start justify-center ml-12 space-x-4 lg:justify-start">
                                <Image className="w-24 rounded-lg shadow-lg md:w-40 object-cover h-64" width="170" height={200} src={servicio?.gallery[2].img} alt={servicio?.gallery[2].alt} />
                                <Image className="w-32 rounded-lg shadow-lg md:w-56 object-cover h-80" width="200" height={200} src={servicio?.gallery[3].img} alt={servicio?.gallery[3].alt} />
                            </div>
                        </div>
                    </div>
                </div>
